...
const ENCODING_TYPES: (typeof Float32Array | typeof Int8Array | typeof Int16Array | typeof Int32Array | typeof Uint8Array | typeof Uint16Array | typeof Uint32Array | null)[] = [
  null,
  Float32Array,
  null,
  Int8Array,
...
const GET_METHODS: Record<string, string> = {
...
function isBigEndian(): boolean {
  if (bigEndian === null) {
    ...
    new Uint8Array(buffer)[0] = 0xAA;
    new Uint8Array(buffer)[1] = 0xBB;
    bigEndian = new Uint16Array(buffer)[0] === 0xAABB;
  }
  return bigEndian;
}
...
function copyFromBuffer(
  source: ArrayBuffer,
  Type: typeof Float32Array | typeof Int8Array | typeof Int16Array | typeof Int32Array | typeof Uint8Array | typeof Uint16Array | typeof Uint32Array,
  position: number,
  length: number,
  ...
  const getMethod = GET_METHODS[Type.name]!;
  const littleEndian = !fromBigEndian;
  const result = new Type(length);

  for (let i = 0; i < length; i++) {
    (result as never)[i] = (view as never)[getMethod](i * Type.BYTES_PER_ELEMENT, littleEndian);
  }
...
interface ParsedAttribute {
  type: number;
  cardinality: number;
  values: Float32Array | Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array;
  normalized: boolean;
}
